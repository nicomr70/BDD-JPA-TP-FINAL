...
public class EcosSessionProgrammationComponent {
    ...
    public EcosSessionProgrammationEntity updateEcosSessionProgrammation(Long id, EcosSessionProgrammationEntity ecosSessionProgrammationEntity){
        EcosSessionProgrammationEntity ecosSessionProgrammation = ecosSessionProgrammationRepository.findById(id).orElseThrow();
        ecosSessionProgrammation.setLabel(ecosSessionProgrammationEntity.getLabel());
        return ecosSessionProgrammationRepository.save(ecosSessionProgrammation);
